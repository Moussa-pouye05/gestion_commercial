...
$fourn = new Fournisseur((int)$id, $nom, $telephone,$adresse);

$result = $con->editFournisseur($fourn);

if(!$result){
    echo json_encode(["success"=>false,"message"=>"Erreur lors de la modification du fournisseur"]);
    exit;
}
